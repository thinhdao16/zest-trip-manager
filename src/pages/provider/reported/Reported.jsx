...
function Reported() {
    ...
    const filteredProviders = provider?.providers?.filter(providers => providers?.status !== 'PROCESSING' && provider.status !== 'REJECT');
              ...
              >
                ...
                <div className="container flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                         ...
                         */}
                                                <span>
                                                    <Label color={statusColors[dataProvider?.status] || 'error'}>{dataProvider?.status}</Label>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    {expandedItems[index] && (
                                        <Fade in={expandedItems[index]} timeout={700}>
                                            <div>
                                                ...
                                                )?.length > 0 && <div className="p-4 bg-slate-100 grid grid-cols-4 mb-4">
                                                ...
                                                {filterByTargetProviderId(report?.providers, dataProvider?.id
                                                    ...
                                                    filterByTargetProviderId(report?.providers, dataProvider?.id
                                                        ...
                                                        <div className=" px-4  mb-4 py-1  relative " key={index}>
                                                            ...
                                                            >
                                                                <MenuItem onClick={() => handleRequest(dataBookingInWeek?.id
                                                                    , "ACCEPTED")}>
                                                                    <Iconify icon="fluent-mdl2:accept" className="text-green-500" sx={{ mr: 2 }} />
                                                                    <span className='text-green-500'>
                                                                        Accept
                                                                    </span>
                                                                </MenuItem>
                                                                <MenuItem onClick={() => handleRequest(dataBookingInWeek?.id
                                                                    , "REJECT")} sx={{ color: 'error.main' }}>
                                                            ...
                                                            <div className="grid grid-cols-4">
                                                                ...
                                                                <div>
                                                                    <span>{dataBookingInWeek?.report_type
                                                                    }</span>
                                                                </div>
                                                                <div>

                                                                    <Label color={getStatusColorClassName[dataBookingInWeek?.status] || 'error'}>{dataBookingInWeek?.status}</Label>
                                                                </div>
                                                            </div>
