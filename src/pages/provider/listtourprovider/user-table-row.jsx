...
import ModalListProviderTour from '../modal/modal-list-provider-tour';
...
export default function UserTableRow({
  ...
  return (
    <>
      ...
      {/* modal */}
      <ModalListProviderTour openModal={openModal} setOpenModal={setOpenModal} idProvider={idProvider} />
      {/* end */}
      <Popover
        open={!!open}
        anchorEl={open}
